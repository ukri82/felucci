...
var current="World cup has started!"    //-->enter what you want the script to display when the target date and time are reached, limit to 20 characters
...
theyear=yr;themonth=m;theday=d;thehour=hr;theminute=min;
    ...
    if(dday<=0&&dhour<=0&&dmin<=0&&dsec<=0){
        document.getElementById('CountDownDiv').innerHTML=current;
        return;
    }
    else {
        document.getElementById('CountDownDiv').innerHTML="World cup starts in "+dday+ " days, "+dhour+" hours, "+dmin+" minutes, and "+dsec+" seconds";
